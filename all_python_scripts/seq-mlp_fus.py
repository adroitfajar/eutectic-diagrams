...
This script executes learning and prediction of fusion enthalpy using ANN Sequential Multilayer Perceptrons (seq-MLP)
...
plt.savefig('fig_S2f.jpg', dpi=300, bbox_inches='tight')
...
dpi_assign = 500
plt.savefig('mlp_fus_fig2.jpg', dpi=dpi_assign, bbox_inches='tight')
...
[(j.label.set_fontproperties('arial'), j.label.set_fontsize(16)) for j in ycoord]
dpi_assign = 500
plt.savefig('mlp_fus_fig3.jpg', dpi=dpi_assign, bbox_inches='tight')
...
# ycoord = ax.yaxis.get_major_ticks()
# plt.axis([-3, 93, -3, 93])
# ax.legend(['Train', 'Test'], prop=fonts, loc='lower right')
# [x.label1.set_fontfamily('arial') for x in xcoord]
# [x.label1.set_fontsize(16) for x in xcoord]
# [y.label1.set_fontfamily('arial') for y in ycoord]
# [y.label1.set_fontsize(16) for y in ycoord]
# dpi_assign = 500
# plt.savefig('fig_1f.jpg', dpi=dpi_assign, bbox_inches='tight')
...
# np.savetxt('predicted-fus_mlp.csv', value_pred, delimiter=',')