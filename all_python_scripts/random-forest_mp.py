...
This script executes learning and prediction of melting point using Random Forest
...
dpi_assign = 500
plt.savefig('rf_mp_fig1.jpg', dpi=dpi_assign, bbox_inches='tight')
...
[(j.label.set_fontproperties('arial'), j.label.set_fontsize(14)) for j in ycoord]
dpi_assign = 500
plt.savefig('rf_mp_fig2.jpg', dpi=dpi_assign, bbox_inches='tight')
...
[(j.label.set_fontproperties('arial'), j.label.set_fontsize(14)) for j in ycoord]
dpi_assign = 500
plt.savefig('rf_mp_fig3.jpg', dpi=dpi_assign, bbox_inches='tight')
...
# dpi_assign = 500
# plt.savefig('fig_1a.jpg', dpi=dpi_assign, bbox_inches='tight')
...
# [(j.label.set_fontproperties('arial'), j.label.set_fontsize(14)) for j in ycoord]
# dpi_assign = 500
# plt.savefig('fig_S2a.jpg', dpi=dpi_assign, bbox_inches='tight')
...
dpi_assign = 500
plt.savefig('rf_mp_fig4.jpg', dpi=dpi_assign, bbox_inches='tight')
...
# np.savetxt('predicted-mp_rf.csv', value_pred, delimiter=',')