...
This script executes learning and prediction of fusion enthalpy using XGBoost
...
dpi_assign = 500
plt.savefig('xgb_fus_fig1.jpg', dpi=dpi_assign, bbox_inches='tight')
...
[(j.label.set_fontproperties('arial'), j.label.set_fontsize(16)) for j in ycoord]
dpi_assign = 500
plt.savefig('xgb_fus_fig2.jpg', dpi=dpi_assign, bbox_inches='tight')
...
[(j.label.set_fontproperties('arial'), j.label.set_fontsize(16)) for j in ycoord]
dpi_assign = 500
plt.savefig('xgb_fus_fig3.jpg', dpi=dpi_assign, bbox_inches='tight')
...
# dpi_assign = 500
# plt.savefig('fig_1e.jpg', dpi=dpi_assign, bbox_inches='tight')
...
# dpi_assign = 500
# plt.savefig('fig_S2e.jpg', dpi=dpi_assign, bbox_inches='tight')
...
dpi_assign = 500
plt.savefig('xgb_fus_fig4.jpg', dpi=dpi_assign, bbox_inches='tight')
...
# np.savetxt('predicted-fus_xgb.csv', value_pred, delimiter=',')