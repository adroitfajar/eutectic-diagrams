...
dpi_assign = 500
plt.savefig('xgb_mp_fig1.jpg', dpi=dpi_assign, bbox_inches='tight')
...
[(j.label.set_fontproperties('arial'), j.label.set_fontsize(14)) for j in ycoord]
dpi_assign = 500
plt.savefig('xgb_mp_fig2.jpg', dpi=dpi_assign, bbox_inches='tight')
...
[(j.label.set_fontproperties('arial'), j.label.set_fontsize(14)) for j in ycoord]
dpi_assign = 500
plt.savefig('xgb_mp_fig3.jpg', dpi=dpi_assign, bbox_inches='tight')
...
# dpi_assign = 500
# plt.savefig('fig_1b.jpg', dpi=dpi_assign, bbox_inches='tight')
...
# [(j.label.set_fontproperties('arial'), j.label.set_fontsize(14)) for j in ycoord]
# dpi_assign = 500
# plt.savefig('fig_S2b.jpg', dpi=dpi_assign, bbox_inches='tight')
...
dpi_assign = 500
plt.savefig('xgb_mp_fig4.jpg', dpi=dpi_assign, bbox_inches='tight')
...
# np.savetxt('predicted-mp_xgb.csv', value_pred, delimiter=',')